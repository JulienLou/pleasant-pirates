<template>
  <div :class="templateColorChoice">
    <NavbarSide/>
    <section class="policy navbar-margin">
      ...
      <div class="container">
        ...
        <p>Si vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir le signaler dans la rubrique contact www.julienlouvet.com, en décrivant le problème de la manière la plus précise possible (page posant problème, type d’ordinateur et de navigateur utilisé, …).</p>
        ...
        <p>Auteur des fonds d'écran du memory-game, jackpot-game: <a class="cursor-pointer underline" href="http://www.freepik.com" target="_blank">Designed by upklyak / Freepik</a></p>
        <p>Auteur des fonds d'écran du home-page/accueil, about/à propos, slide-game: <a class="cursor-pointer underline"  href="https://www.freepik.com">designed by Vectorpouch - Freepik.com</a></p>
...
.policy{
  ...
  padding-top: 1.7rem;
  h2{
    color: rgb(237, 221, 148);
    font-size: 2.2em;
    padding: 2rem;
    text-align: center;
  }
  h3{
    color: rgb(148, 208, 237);
    margin-top: 1.7rem;
    font-size: 1.4em;
    padding: .7rem 0;
  }
